...
public class single_task2 extends AppCompatActivity {

    private static final String TAG = "single_task2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.single_task2);
...
//                setContentView(R.layout.second_activity);
                Intent intent = new Intent(single_task2.this,single_task.class);
