...
public class single_task extends AppCompatActivity {
    ...
    private static final String TAG = "single_task";
...
//                setContentView(R.layout.second_activity);
                Intent intent = new Intent(single_task.this,MainActivity.class);
        ...
        mybtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d(TAG,"Button has been clicked!");
//                setContentView(R.layout.second_activity);
                Intent intent = new Intent(single_task.this,single_task.class);
                startActivity(intent);
            }
        });
        ...
        mybtn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d(TAG,"Button has been clicked!");
//                setContentView(R.layout.second_activity);
                Intent intent = new Intent(single_task.this,single_task2.class);
                startActivity(intent);
            }
        });
    }
